...
public class golgiHomeAutomation_updateLightDevice_rspArg
{
    ...
    public golgiHomeAutomation_updateLightDevice_rspArg(){
        this(true);
    }

    public golgiHomeAutomation_updateLightDevice_rspArg(boolean isSetDefault){
        super();
    ...
    public golgiHomeAutomation_updateLightDevice_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public golgiHomeAutomation_updateLightDevice_rspArg(String payload){
