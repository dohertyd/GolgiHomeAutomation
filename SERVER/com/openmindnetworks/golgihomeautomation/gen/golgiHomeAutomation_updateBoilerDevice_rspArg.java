...
public class golgiHomeAutomation_updateBoilerDevice_rspArg
{
    ...
    public golgiHomeAutomation_updateBoilerDevice_rspArg(){
        this(true);
    }

    public golgiHomeAutomation_updateBoilerDevice_rspArg(boolean isSetDefault){
        super();
    ...
    public golgiHomeAutomation_updateBoilerDevice_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public golgiHomeAutomation_updateBoilerDevice_rspArg(String payload){
